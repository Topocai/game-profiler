const BASE_FIELDS = "name,id,url,first_release_date,summary"

const BasicFetch = (bearer_access_token, type, {fields = "*", limit=10, condition, search }) => {
    let bodyField = `fields ${fields}; limit ${limit};`
...
const Get_GameByName = (bearer_access_token, name) => {
    ...
    const fields = BASE_FIELDS + ",similar_games"
    const queryResult = BasicFetch(bearer_access_token, "games", { fields: fields, search: name, limit: 3 })
    return queryResult
}
